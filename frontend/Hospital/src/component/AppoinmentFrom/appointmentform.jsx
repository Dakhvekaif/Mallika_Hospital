...
const AppointmentForm = () => {
  ...
  useEffect(() => {
    fetch(`${API}/api/departments/`)
      ...
      .catch(async err => {
        const msg = await err.text?.() || 'Something went wrong';
        console.error("Department fetch error:", msg);
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`${API}/api/appointments/`, {
      ...
      .then(async res => {
        ...
        console.log(payload);  // 📝 Log it for debugging
        console.error("Validation error:", errorData);  // 👀 Print it
